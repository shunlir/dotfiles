...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            wibox.layout.margin(wibox.widget.systray(), dpi(4), dpi(4), dpi(4), dpi(4)),
            mytextclock,
            s.mylayoutbox,
        },
    }
...
globalkeys = gears.table.join(
    awful.key({ modkey,           }, "i",     function()
	    scratch.toggle("st -c scratch -t scratch", {class="scratch"})
        end,
        {description="toggle terminal", group="client"}),
    ...
    awful.key({ modkey,           }, "o", function () awful.spawn("i3lock -c 708090") end,
...
-- Start ibus at startup, otherwise some apps can't use ibus
